                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('barber.services.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="service_name" class="block mt-1 w-full" type="text" name="service_name" :value="old('service_name')" required autofocus placeholder="Contoh: Potong rambut" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="price" class="block mt-1 w-full" type="number" name="price" :value="old('price')" required min="0" placeholder="Contoh: 25000" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="duration_minutes" class="block mt-1 w-full" type="number" name="duration_minutes" :value="old('duration_minutes')" required min="1" placeholder="Contoh: 30" />
