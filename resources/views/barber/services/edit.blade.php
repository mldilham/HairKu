    ...
    <section class="py-5" style="background-color: var(--light-bg);">
        <div class="container py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold mb-1">Edit <span class="text-primary-custom">Layanan</span></h2>
                    <p class="text-muted mb-0">Edit layanan barber Anda</p>
                </div>
                        ...
                        <form method="POST" action="{{ route('barber.services.update', $service->id) }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="service_name"
                                       name="service_name" value="{{ old('service_name', $service->service_name) }}" required
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-lg me-2"></i> Perbarui Layanan
                                </button>
                            </div>
                        </form>
                    </div>
